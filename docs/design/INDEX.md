...
| [拖拽时隐藏 Mini Toolbar](./drag-hide-mini-toolbar.md)   | 拖拽交互优化和动画效果        | ✅ 已确认 | 2025-12-06 |
...
| isDragging, 拖拽状态, 拖拽隐藏            | [拖拽时隐藏 Mini Toolbar](./drag-hide-mini-toolbar.md)                             |
| onMoveStart, onMoveEnd, 画布拖拽          | [拖拽时隐藏 Mini Toolbar](./drag-hide-mini-toolbar.md)                             |
| onNodeDragStart, onNodeDragStop, 节点拖拽 | [拖拽时隐藏 Mini Toolbar](./drag-hide-mini-toolbar.md)                             |
| setDragging, 拖拽状态管理                 | [拖拽时隐藏 Mini Toolbar](./drag-hide-mini-toolbar.md)                             |
| opacity, pointerEvents, 淡入淡出动画      | [拖拽时隐藏 Mini Toolbar](./drag-hide-mini-toolbar.md)                             |
...
| 日期       | 更新内容                                                                                                      | 更新者      |
| ---------- | ------------------------------------------------------------------------------------------------------------- | ----------- |
| 2025-12-06 | 添加拖拽时隐藏 Mini Toolbar 设计文档（拖拽状态管理、事件监听、平滑动画实现）                                  | Claude Code |
