...
| `node.addSiblingAbove` | 在上方添加兄弟节点 | -                      | 在当前节点上方添加兄弟节点 | ✅ 已实现 |
| `node.addSiblingBelow` | 在下方添加兄弟节点 | `Enter`                | 在当前节点下方添加兄弟节点 | ✅ 已实现 |
...
| 命令 ID          | 名称     | 快捷键  | 说明                   | 状态      |
| ---------------- | -------- | ------- | ---------------------- | --------- |
| `edit.copy`      | 复制节点 | `Cmd+C` | 复制当前节点到剪贴板   | ⏳ 待实现 |
| `edit.cut`       | 剪切节点 | `Cmd+X` | 剪切当前节点到剪贴板   | ⏳ 待实现 |
| `edit.paste`     | 粘贴节点 | `Cmd+V` | 粘贴剪贴板内容为子节点 | ⏳ 待实现 |
| `edit.duplicate` | 复制节点 | `Cmd+D` | 复制节点作为兄弟节点   | ⏳ 待实现 |
...
| 命令 ID        | 名称 | 快捷键        | 说明               | 状态      |
| -------------- | ---- | ------------- | ------------------ | --------- |
| `mindmap.save` | 保存 | `Cmd+S`       | 保存思维导图到云端 | ✅ 已实现 |
| `history.undo` | 撤销 | `Cmd+Z`       | 撤销上一次操作     | ✅ 已实现 |
| `history.redo` | 重做 | `Cmd+Shift+Z` | 重做已撤销的操作   | ✅ 已实现 |
